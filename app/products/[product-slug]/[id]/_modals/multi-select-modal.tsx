...
export function MultiSelectModal({ isOpen, onClose }: MultiSelectModalProps) {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={(open) => !open && handleClose()}>
      <DialogContent className="w-[95vw] sm:w-[90vw] lg:w-[95vw] max-w-7xl h-[90vh] sm:h-[85vh] p-0 gap-0 bg-background border border-border/50 overflow-scroll flex rounded-none flex-col">
        <MultiSelectHeader
          name={name || "Product"}
...
//   return (
//     <Dialog open={isOpen} onOpenChange={(open) => !open && handleClose()}>
//       <DialogContent className="w-[95vw] sm:w-[90vw] lg:w-[95vw] max-w-7xl h-[90vh] sm:h-[85vh] p-0 gap-0 bg-background border border-border/50 overflow-hidden flex flex-col">
//         <MultiSelectHeader
//           name={name || "Product"}
//           total_price={totals.total_price}
//         />
