...
function CommandItem({
  ...
  return (
    <CommandPrimitive.Item
      ...
      className={cn(
        "data-[selected=true]:bg-input data-[selected=true]:text-foreground hover:text-background! [&_svg:not([class*='text-'])]:text-muted-foreground relative flex items-center gap-2 hover:bg-foreground!  cursor-pointer px-2 py-1.5 text-sm outline-hidden select-none data-[disabled=true]:pointer-events-none data-[disabled=true]:opacity-50 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
        className
      )}
      {...props}
    />
