...
//               className="text-center section_header">
...
//               className="mt-6 w-full md:w-1/2 lg:w-1/3 mx-auto text-pretty text-center text-muted-foreground leading-relaxed">
...
//               meticulously crafted ensuring the highest quality exquisite
//               finish.
//             </motion.p>
//           </div>
