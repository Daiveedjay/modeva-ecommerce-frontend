  ...
  return (
    <DialogHeader className="p-4 sm:p-6 md:p-8 lg:p-10 pb-4 sm:pb-5 md:pb-6 lg:pb-6 border-b border-border/40 bg-background/50 backdrop-blur-sm shrink-0">
      <div className="flex flex-col sm:flex-row sm:justify-between sm:items-end gap-4 sm:gap-0">
        <div className="space-y-1.5 max-w-3/4 sm:max-w-full">
          <p className="text-[9px] text-left sm:text-xs uppercase tracking-[0.3em] text-muted-foreground font-bold">
            Batch Inventory Selection
          </p>
          <DialogTitle className="text-xl text-left sm:text-3xl md:text-4xl lg:text-5xl font-light tracking-tight font-beatrice-deck text-foreground">
            {name}
          </DialogTitle>
        </div>
